...
function DoughnutChart({ data, width, height }) {
  ...
  return (
    <div className="flex-grow flex flex-col justify-center">
      ...
      <div id="dashboard-card-06-legend" className="px-5 pt-2 pb-6">
