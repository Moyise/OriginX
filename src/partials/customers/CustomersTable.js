...
function CustomersTable({ selectedItems }) {
  ...
  return (
    <div className="bg-black shadow-lg rounded-sm border border-gray-800 relative">
      <header className="px-5 py-4">
        <h2 className="font-semibold text-gray-400">
          All Customers <span className="text-white font-medium">248</span>
        </h2>
      </header>
      <div>
        {/* Table */}
        <div className="overflow-x-auto">
          <table className="table-auto w-full">
            {/* Table header */}
            <thead className="text-xs font-semibold uppercase text-gray-300 bg-black border-t border-b border-gray-800">
              <tr>
