...
function TeamTilesCard(props) {
  return (
    <div className="col-span-full sm:col-span-6 xl:col-span-4 bg-black shadow-lg rounded-sm border border-gray-800">
      <div className="flex flex-col h-full">
        ...
        <div className="flex-grow p-5">
          <div className="flex justify-between items-start">
              ...
              <div className="flex mb-2">
                ...
                <div className="mt-1 pr-1">
                  <Link
                    ...
                    to={props.link}
                  >
                    <h2 className="text-xl justify-center font-semibold text-gray-200">
                      {props.name}
                    </h2>
                  </Link>
            ...
            {/* Menu button */}
            <EditMenu className="relative inline-flex flex-shrink-0">
              <li>
                <Link
          ...
          {/* Bio */}
          <div className="mt-2">
            <div className="text-sm text-gray-400">{props.content}</div>
          </div>
        </div>
        {/* Card footer */}
