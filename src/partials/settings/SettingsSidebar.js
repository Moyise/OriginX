...
function SettingsSidebar() {
  return (
    <div className="flex flex-nowrap overflow-x-scroll no-scrollbar md:block md:overflow-auto px-3 py-6 border-b md:border-b-0 md:border-r border-gray-800 md:w-60 md:space-y-3 bg-black">
      {/* Group 1 */}
      <div>
        <div className="text-xs font-semibold text-gray-300 uppercase mb-3">
          Business settings
        </div>
        <ul className="flex flex-nowrap md:block mr-3 md:mr-0">
          <li className="mr-0.5 md:mr-0 md:mb-0.5">
            <a
              className="flex items-center px-2.5 py-2 rounded whitespace-nowrap bg-gray-900"
              href="#0"
            >
              <svg
                className="w-4 h-4 flex-shrink-0 fill-current text-indigo-500 mr-2"
                viewBox="0 0 16 16"
              >
          ...
          <li className="mr-0.5 md:mr-0 md:mb-0.5">
            ...
            >
              <svg
                className="w-4 h-4 flex-shrink-0 fill-current text-gray-500 mr-2"
                viewBox="0 0 16 16"
              >
                <path d="M14.3.3c.4-.4 1-.4 1.4 0 .4.4.4 1 0 1.4l-8 8c-.2.2-.4.3-.7.3-.3 0-.5-.1-.7-.3-.4-.4-.4-1 0-1.4l8-8zM15 7c.6 0 1 .4 1 1 0 4.4-3.6 8-8 8s-8-3.6-8-8 3.6-8 8-8c.6 0 1 .4 1 1s-.4 1-1 1C4.7 2 2 4.7 2 8s2.7 6 6 6 6-2.7 6-6c0-.6.4-1 1-1z" />
              </svg>
              <span className="text-sm font-medium text-gray-400 hover:text-gray-700">
                My notifications
              </span>
            </a>
          </li>
