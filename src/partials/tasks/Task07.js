...
function Task07() {
  return (
    <div className="bg-black shadow-lg rounded-sm border border-gray-800 p-4">
      {/* Body */}
      <div className="mb-3">
        {/* Title */}
        <h2 className="font-semibold text-gray-300 mb-1">Manage internal feedback</h2>
      </div>
      {/* Meta */}
      ...
      {/* List */}
      <ul className="mt-3">
        <li className="flex items-center border-t border-gray-800 py-2">
          <svg
