  ...
  return (
    <div className="lg:w-64">
      ...
      <div
        id="sidebar"
        ref={sidebar}
        className={`absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 transform h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 flex-shrink-0 bg-black p-4 transition-transform duration-200 ease-in-out ${
              ...
              <ul className={`pl-9 mt-1 ${!page.startsWith("team-") && "hidden"}`}>
                <li className="mb-1 last:mb-0">
                  <NavLink
                    ...
                    to="/team-tabs"
                    className={`block text-gray-200 hover:text-white transition duration-150 ${
                      page === "team-tabs" && "text-indigo-400 hover:text-indigo-400"
                    }`}
                  >
                ...
                <li className="mb-1 last:mb-0">
                  <NavLink
                    ...
                    to="/team-tiles"
                    className={`block text-gray-200 hover:text-white transition duration-150" ${
                      page === "team-tiles" && "text-indigo-400 hover:text-indigo-400"
                    }`}
                  >
