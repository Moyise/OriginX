...
function DashboardCard07() {
  return (
    <div className="col-span-full xl:col-span-8 bg-black shadow-lg rounded-sm border border-gray-900">
      ...
      <div className="p-3">
        ...
        <div className="overflow-x-auto">
          <table className="table-auto w-full">
            {/* Table header */}
            <thead className="text-xs uppercase text-gray-400 bg-black rounded-sm">
              <tr>
                <th className="p-2">
