...
function DashboardCard11() {
  return (
    <div className="col-span-full xl:col-span-6 bg-black shadow-lg rounded-sm border border-gray-900">
      <header className="px-5 py-4 border-b border-gray-800">
        <h2 className="font-semibold text-white">Income/Expenses</h2>
      </header>
      <div className="p-3">
        {/* Card content */}
        {/* "Today" group */}
        <div>
          <header className="text-xs uppercase text-gray-400 bg-black rounded-sm font-semibold p-2">
            Today
          </header>
          <ul className="my-1">
            {/* Item */}
              ...
              <div className="flex-grow flex items-center border-b border-gray-100 text-sm py-2">
                <div className="flex-grow flex justify-between">
                  <div className="self-center">
                    <a className="font-medium text-white hover:text-gray-600" href="#0">
                      Qonto
                    </a>{" "}
                    billing
                  </div>
                  <div className="flex-shrink-0 self-start ml-2">
                    <span className="font-medium text-gray-400">-$49.88</span>
                  </div>
                </div>
              </div>
            </li>
