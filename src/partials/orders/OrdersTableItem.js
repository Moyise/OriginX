  ...
  return (
    <tbody className="text-sm">
      ...
      <tr className="text-gray-500">
        ...
        <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
          <div className="font-medium text-gray-200">{props.customer}</div>
        </td>
        <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
      ...
      */}
      ...
      >
        <td colSpan="10" className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
          <div className="flex items-center bg-gray-900 p-3 -mt-3">
