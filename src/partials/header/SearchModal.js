...
function SearchModal() {
  ...
  return (
    <div>
      ...
      <button
        ref={trigger}
        className={`w-8 h-8 flex items-center justify-center bg-black hover:bg-gray-900 transition duration-150 rounded-full ml-3 ${
          searchOpen && "bg-gray-900"
        }`}
        onClick={() => {
      ...
      >
        <div
          className="bg-black overflow-auto max-w-2xl w-full max-h-full rounded shadow-lg"
          ref={searchContent}
        >
          {/* Search form */}
          <form className="border-b border-gray-900 ">
            <div className="relative ">
              ...
              <input
                id="modal-search"
                className="w-full bg-black border-0 focus:ring-transparent placeholder-gray-400 appearance-none py-3 pl-10 pr-4 text-gray-200"
                type="search"
          ...
          >
            ...
            <div className="mb-3 last:mb-0">
              ...
              <ul className="text-sm">
                <li>
                  <Link
                    className="flex items-center p-2 text-gray-400 hover:text-white hover:bg-gray-900 rounded group"
                    to="#0"
                ...
                <li>
                  ...
                  >
                    ...
                    <span>Access Origin X on mobile and TV</span>
                  </Link>
                </li>
                <li>
                  <Link
