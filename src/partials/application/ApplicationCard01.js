...
function ApplicationCard01(props) {
  return (
    <div className="col-span-full sm:col-span-6 xl:col-span-3 bg-black shadow-lg rounded-sm border border-gray-800 overflow-hidden">
        ...
        <div className="flex-grow flex flex-col p-5">
          ...
          <div className="flex-grow">
            ...
            <header className="mb-2">
              <h3 className="text-lg text-gray-200 font-semibold mb-1">{props.title}</h3>
            ...
            <div className="flex items-center space-x-2 mb-4">
              ...
              <div className="flex space-x-1">
                <button>
                  ...
                  <svg
                    className={`w-4 h-4 fill-current ${
                      Math.round(props.rating) > 0 ? "text-yellow-500" : "text-gray-300"
                    }`}
                    viewBox="0 0 16 16"
                  >
                ...
                <button>
                  ...
                  <svg
                    className={`w-4 h-4 fill-current ${
                      Math.round(props.rating) > 1 ? "text-yellow-500" : "text-gray-300"
                    }`}
                    viewBox="0 0 16 16"
                  >
                    <path d="M10 5.934L8 0 6 5.934H0l4.89 3.954L2.968 16 8 12.223 13.032 16 11.11 9.888 16 5.934z" />
                ...
                <button>
                  ...
                  <svg
                    className={`w-4 h-4 fill-current ${
                      Math.round(props.rating) > 2 ? "text-yellow-500" : "text-gray-300"
                    }`}
                    viewBox="0 0 16 16"
                  >
                    <path d="M10 5.934L8 0 6 5.934H0l4.89 3.954L2.968 16 8 12.223 13.032 16 11.11 9.888 16 5.934z" />
                ...
                <button>
                  ...
                  <svg
                    className={`w-4 h-4 fill-current ${
                      Math.round(props.rating) > 3 ? "text-yellow-500" : "text-gray-300"
                    }`}
                    viewBox="0 0 16 16"
                  >
                    <path d="M10 5.934L8 0 6 5.934H0l4.89 3.954L2.968 16 8 12.223 13.032 16 11.11 9.888 16 5.934z" />
                ...
                <button>
                  ...
                  <svg
                    className={`w-4 h-4 fill-current ${
                      Math.round(props.rating) > 4 ? "text-yellow-500" : "text-gray-300"
                    }`}
                    viewBox="0 0 16 16"
                  >
                    <path d="M10 5.934L8 0 6 5.934H0l4.89 3.954L2.968 16 8 12.223 13.032 16 11.11 9.888 16 5.934z" />
