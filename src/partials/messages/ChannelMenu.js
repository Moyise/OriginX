...
function ChannelMenu() {
  ...
  return (
    <div className="relative">
      ...
      <Transition
        className="origin-top-right z-10 absolute top-full left-0 min-w-60 bg-black border border-gray-800 py-1.5 rounded shadow-lg overflow-hidden mt-1"
        show={dropdownOpen}
      ...
      >
        ...
        >
          <li>
            <a
              className="font-medium text-sm text-gray-400 hover:text-gray-600 block py-1.5 px-3"
              href="#0"
              onClick={() => setDropdownOpen(!dropdownOpen)}
            >
