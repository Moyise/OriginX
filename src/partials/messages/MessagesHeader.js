...
function MessagesHeader({ msgSidebarOpen, setMsgSidebarOpen }) {
  return (
    <div className="sticky top-16">
      <div className="flex items-center justify-between bg-black border border-gray-800 px-4 sm:px-6 md:px-5 h-16">
        {/* People */}
        ...
        <div className="flex">
          <button className="p-1.5 flex-shrink-0 rounded border border-gray-800 hover:border-gray-700 shadow-sm ml-2">
