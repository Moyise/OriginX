...
function MessagesSidebar({ msgSidebarOpen, setMsgSidebarOpen }) {
  return (
    ...
    >
      <div
        className="sticky top-16 bg-black overflow-x-hidden overflow-y-auto no-scrollbar flex-shrink-0 border border-gray-800 md:w-72"
      ...
      >
        ...
        <div>
          ...
          <div className="sticky top-0 z-10">
            <div className="flex items-center bg-black border-b border-gray-800 px-5 h-16">
              <div className="w-full flex items-center justify-between">
                {/* Channel menu */}
                <ChannelMenu />
                {/* Edit button */}
                <button className="p-1.5 flex-shrink-0 rounded border border-gray-800 hover:border-gray-300 shadow-sm ml-2">
          ...
          <div className="px-5 py-4">
            ...
            <form className="relative">
              ...
              <input
                id="msg-search"
                className="form-input bg-black border-gray-800 w-full pl-9 focus:border-gray-400"
                type="search"
                placeholder="Search…"
              />
              <button
