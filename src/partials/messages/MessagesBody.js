  ...
  return (
    <div className="flex-grow px-4 sm:px-6 md:px-5 py-6">
      ...
      <div className="flex items-start mb-4 last:mb-0">
        ...
        <div>
          <div className="text-sm bg-indigo-500 text-white p-3 rounded-lg rounded-tl-none border border-transparent shadow-md mb-1">
            ...
            <br />
            Sed lectus vestibulum mattis ullamcorper velit sed. Ut sem nulla pharetra diam
            sit amet 🎁
          </div>
          <div className="flex items-center justify-between">
      ...
      <div className="flex justify-center">
        <div className="inline-flex items-center justify-center text-xs font-medium px-2.5 py-1 bg-black border border-gray-800 rounded-full my-5">
          Tuesday, 20 January
        </div>
      </div>
      {/* Chat msg */}
