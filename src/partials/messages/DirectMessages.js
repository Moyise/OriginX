...
function DirectMessages({ msgSidebarOpen, setMsgSidebarOpen }) {
  return (
    <div className="mt-4">
      ...
      <ul className="mb-6">
        <li className="-mx-2">
          <button
            className="flex items-center justify-between w-full p-2 rounded bg-gray-900"
        ...
        <li className="-mx-2">
          ...
          >
            <div className="flex items-center truncate">
              ...
              />
              <div className="truncate">
                <span className="text-sm font-medium text-gray-400">Tisha Yanchev</span>
              </div>
            </div>
            <div className="flex items-center ml-2">
              <div className="text-xs inline-flex font-medium bg-indigo-400 text-white rounded-full text-center leading-5 px-2">
        ...
        <li className="-mx-2">
          ...
          >
            <div className="flex items-center truncate">
              ...
              />
              <div className="truncate">
                <span className="text-sm font-medium text-gray-400">Jerzy Wierzy</span>
              </div>
            </div>
            <div className="flex items-center ml-2">
              <img
        ...
        <li className="-mx-2">
          ...
          >
            <div className="flex items-center truncate">
              ...
              />
              <div className="truncate">
                <span className="text-sm font-medium text-gray-400">Simona Lürwer</span>
              </div>
            </div>
            <div className="flex items-center ml-2">
              <svg
